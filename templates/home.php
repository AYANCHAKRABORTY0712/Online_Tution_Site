...
<link href="../css/theme.css" rel="stylesheet">
    <div id="home">
    <div>
        <h1 style="text-align: center">EduVerse</h1>
        <h3 style="text-align: center">Welcome to our e-learning platform.</h3>
    </div>
    <div>
        <h3 style="text-align: center">This website is build to connect students and mentors.</h3>
        <h3 style="text-align: center">Let's learn joyfully. Let's reach new heights.</h3>
    </div>
    </div>
    ...
    <main>
      ...
      <section class="py-6">
        ...
        <div class="container">
          <div class="row">
            <h1 class="header-title display-4 header text-start mb-5">MAJOR SUBJECTS</h1>
            <?php $query = "SELECT * FROM SUBJECT";
                  ...
                  while($subject = $subjects->fetch_assoc())
                  {
                      ...
                      <div class="card border-0 h-100">
                        <div class="position-relative"><img class="w-100" src="../images/'.$subject['SUBNAME'].'.jpg" alt="courses" />
                        </div>
                        <div class="card-body px-0 py-3">
                          <h5 class="mb-0 font-sans-serif fw-bold fs-md-0 fs-lg-1">'.$subject['SUBNAME'].'</h5><a class="text-muted fs--1 stretched-link text-decoration-none" href="login.php">Department of '.$subject['STREAM'].'</a>
                          <div class="badge bg-primary rounded-0" style="padding: 11.1px 21px">Rs. '.$subject['PRICE'].'</div>
                        </div>
                      </div>
                    </div>';
                  }
      ...
      <section class="bg-secondary">
        ...
        <div class="container">
          <div class="row g-3">
            <h1 class="header-title-explore display-4 header text-start mb-5"> Explore EduVerse</h1>
      ...
      <section class="bg-soft-primary">
        ...
        <div class="container">
          <div class="row flex-center">
            <div class="col-lg-5 col-xl-4"><img class="w-100" src="assets/img/illustrations/cta.png" alt="..." /></div>
            <div class="col-lg-5 col-xl-4">
              <h1 class="fw-normal text-secondary mb-4">Get Regular <br />Updates from</h1><img src="assets/img/logos/logo-footer.png" height="75" alt="..." />
              ...
              <form class="row gx-2 gy-2 align-items-center">
                <div class="col">
                  <div class="input-group-icon">
                    ...
                    <input class="form-control input-box form-eduprix-control text-light" id="inputEmailCta" type="email" placeholder="Email" />
                  </div>
                </div>
                <div class="d-grid">
      ...
      <section class="bg-secondary">
        ...
        <div class="container">
          <div class="row">
            <div class="col-12 col-sm-12 col-lg-6 mb-4 order-0 order-sm-0"><a class="text-decoration-none" href="#"><img src="assets/img/logos/logo-footer.png" height="75" alt="..." /></a>
              <p class="text-light my-4">We're a worldwide community for online learning and teaching<br class="d-none d-sm-block" />where anybody can acquire new skills and accomplish their<br class="d-none d-sm-block" />objectives by connecting with others. We are dedicated to <br class="d-none d-sm-block" />making a positive difference in the future of education.</p>
            </div>
            <div class="col-6 col-sm-4 col-lg-2 mb-3 order-2 order-sm-1">
              <h3 class="lh-lg fw-bold mb-4 text-light font-sans-serif">EduVerse</h3>
          ...
          <div class="row justify-content-md-between justify-content-evenly py-4">
            ...
            <div class="col-12 col-sm-8 col-md-6">
              <p class="fs--1 fw-light my-2 text-center text-md-end text-200"> Made with&nbsp;
                ...
                </svg>&nbsp;by&nbsp;<a class="fw-bold text-primary" href="https://themewagon.com/" target="_blank">ChakraDevs</a>
              </p>
            </div>
          </div>
        </div>
    ...
    <footer class="bg-light text-center text-lg-start">
        <div class="container p-4">
            <p class="text-center">© 2024 Online Education Platform</p>
        </div>
    </footer>
</body>
